...
```{note}
The code for this example is available at [https://github.com/Mews/pyrobloxbot-examples/blob/main/anti-afk/main.py](https://github.com/Mews/pyrobloxbot-examples/blob/main/anti-afk/main.py).
```
